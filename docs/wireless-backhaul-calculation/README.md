...
这里默认 $L_{\mathrm{PSDU}}^{\mathrm{agg}}$ 使用 bit 表示。

若 $L_{\mathrm{PSDU}}^{\mathrm{agg}}$ 使用 Byte 表示，则应写成：
...
$$
d_{\mathrm{ONT}\to\mathrm{AP}}=10\ \mathrm{m}.
$$
...
$$
L_{\mathrm{payload}}^{\mathrm{agg}}
\approx10500N_{\mathrm{MPDU}}\ \mathrm{B},
$$

$$
L_{\mathrm{PSDU}}^{\mathrm{agg}}
\approx10648N_{\mathrm{MPDU}}\ \mathrm{B}.
$$
